...
cdi_pov = lm(crm_1000 ~ poverty, data = cdi_data)
summary(cdi_pov)


cdi_pov = lm(crm_1000 ~ poverty + beds, data = cdi_data)
summary(cdi_pov)


cdi_pov = lm(crm_1000 ~ poverty + docs , data = cdi_data)
summary(cdi_pov)

cdi_pov = lm(crm_1000 ~ poverty + docs + beds , data = cdi_data)
summary(cdi_pov)

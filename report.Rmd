...
According to Census Bureau, national percentage of persons 25 years old or older with bachelor’s degrees is 20.8% [4]. Thus, we can use this criteria to divide `bagrad` into two category: higher than national `bagrad` and lower than national `bargrad`.

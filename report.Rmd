...
According to the Census Bureau, national percentage of people 25 years old or older with bachelor’s degrees is 20.8% [4]. Thus, we can use this criteria to divide `bagrad` into two category: higher than national `bagrad` and lower than national `bargrad`.
...
Our first model only using variables we selected: $$ \begin{aligned}
